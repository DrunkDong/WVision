...
{
    [ToolboxItem(false)]
    public partial class UToolFindLine : UserControl, InterfaceUIBase
    {
        public UToolFindLine()
        {
            InitializeComponent();
        }
        ...
        private void UToolFindLine_Load(object sender, EventArgs e)
        {
        ...
        private void button_DrawRoi_Click(object sender, EventArgs e)
        {
            ...
            mToolMachine.DrawWind.DrawLine(out mToolParam.mRoiValue[0], out mToolParam.mRoiValue[1], out mToolParam.mRoiValue[2], out mToolParam.mRoiValue[3]);
            mToolMachine.DrawWind.SetDraw("margin");
            HObject obj;
            HOperatorSet.GenContourPolygonXld(out obj, new HTuple(mToolParam.mRoiValue[0]).TupleConcat(mToolParam.mRoiValue[2]),
                new HTuple(mToolParam.mRoiValue[1]).TupleConcat(mToolParam.mRoiValue[3]));
