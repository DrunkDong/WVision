...
{
    [ToolboxItem(false)]
    public partial class UToolCorrectImage : UserControl,InterfaceUIBase
    {
        public UToolCorrectImage()
        {
            InitializeComponent();
        }
        ...
        private void UToolCorrectImage_Load(object sender, EventArgs e)
        {
            mIsInit = false;
            InitParam();
            mIsInit = true;
        ...
        private void InitParam()
        {
            ...
            for (int i = 0; i < StepInfoList.Count; i++)
            {
               if (StepIndex < (i + 1))
                ...
                if (StepInfoList[i].mToolType == ToolType.NccShapeModel || StepInfoList[i].mToolType == ToolType.ShapeModle)
                {
        ...
        public ResStatus InitRoiShow()
        {
            ...
            for (int i = 0; i < StepInfoList.Count; i++)
            {
               if (StepIndex < (i + 1))
                ...
                if (StepInfoList[i].mToolType == ToolType.DecomposeRGB || StepInfoList[i].mToolType == ToolType.CorrectImage)
                {
                    comboBox_ImageStep.Items.Add((i + 1) + "_" + StepInfoList[i].mShowName);
                }
            }
