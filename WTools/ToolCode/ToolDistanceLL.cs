...
{
    [Serializable]
    public class ToolDistanceLLParam : ToolParamBase
    {
        ...
        public ToolDistanceLLParam()
        {
            mStepInfo = new StepInfo();
            mStepInfo.mToolType = ToolType.DistanceLL;
            mToolType = ToolType.DistanceLL;
            mStepInfo.mToolResultType = ToolResultType.DoubleValue;
            mToolResultType = ToolResultType.DoubleValue;

            mShowName = "直线到直线";
            mToolName = "直线到直线";
            mStepInfo.mShowName = "直线到直线";
    ...
    public class ToolDistanceLL : ToolBase
    {
        ToolDistanceLLParam mToolParam;
        HTuple mDebugWind;
        HTuple mDefectWind;
        HWindow mDrawWind;
        ...
        {
            get => mToolParam;
            set => mToolParam = value as ToolDistanceLLParam;
        }

        public ToolDistanceLL(ToolParamBase toolParam)
        {
            mToolParam = toolParam as ToolDistanceLLParam;
        ...
        public override int DebugRun(HObject objj1,List<StepInfo> StepInfoList, bool ShowObj, out JumpInfo StepJumpInfo)
        {
            ...
            try
            {
                ...
                HOperatorSet.GenContourPolygonXld(out line2, new HTuple( StepInfoList[mToolParam.mLine2StepIndex - 1].mToolRunResul.mParamOutPut[0]).
                    TupleConcat(StepInfoList[mToolParam.mLine2StepIndex - 1].mToolRunResul.mParamOutPut[2]),
                    new HTuple(StepInfoList[mToolParam.mLine2StepIndex - 1].mToolRunResul.mParamOutPut[1]).
                    TupleConcat(StepInfoList[mToolParam.mLine2StepIndex - 1].mToolRunResul.mParamOutPut[3]));
                ...
                mToolParam.ResultString =
                    "距离最小值为" + b.ToString("0.00") + "\r\n" +
                    "距离最大值为" + a.ToString("0.00") + "\r\n" +
                    "距离平均值为" + cc.ToString("0.00");
