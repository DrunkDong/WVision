...
namespace WTools
{
    ...
    public class ToolBlobParam : ToolParamBase
    {
        ...
        public ToolBlobParam()
        {
            ...
            mShowName = "区域提取";
            mToolName = "区域提取";
            StepInfo.mShowName = "区域提取";
            mToolType = ToolType.RegionBlob;
            StepInfo.mToolType = ToolType.RegionBlob;
    ...
    public class ToolBlob : ToolBase
    {
        ...
        public override int ToolRun(HObject objj1, Bitmap obj2, List<StepInfo> StepInfoList, bool ShowObj, out JumpInfo StepJumpInfo)
        {
            StepJumpInfo = new JumpInfo();
            if (mToolParam.ForceOK)
                return 0;
