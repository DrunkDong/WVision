    ...
    static class Program
    {
        public static class AssemblyResolver 
        {
            public static Assembly CurrentDomain_AssemblyResolve(object sender, ResolveEventArgs args)
            {
                ...
                if ("halcondotnet" == args.Name.Substring(0, args.Name.IndexOf(",")))
                {
                    strTempAssmbPath = System.IO.Path.Combine(@"C:\Windows\Speak", "halcondotnet.dll");
                    strTempAssmbPath = strTempAssmbPath.Replace("\\", "\\\\");
        ...
        {            
            ...
            AppDomain.CurrentDomain.AssemblyResolve += new ResolveEventHandler(AssemblyResolver.CurrentDomain_AssemblyResolve);
